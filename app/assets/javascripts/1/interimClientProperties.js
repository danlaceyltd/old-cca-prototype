    ...
    var InterimClientProperties = function (){
        ...
        var table = $('#interimClientProperties').DataTable({
            ...
            fnRowCallback: function(nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                ...
                $('td:eq(4)', nRow).html('<ul class="list list-actions"><li><a href="#">Revoke client</a></li><li><a href="/dashboard/1/valuations?client='+aData[2]+'&address='+aData[0]+'&ba='+aData[1]+'">View valuations</a></li></ul>');
            },
